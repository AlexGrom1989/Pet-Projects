...
def train(model, optimizer, train_loader, epoch):
    ...
    for batch_id, (data, target) in enumerate(tqdm(train_loader)):
        ...
        optimizer.zero_grad()
        output, reconstructions, masked = capsule_net(data, target)
...
if __name__ == '__main__':
    ...
    torch.save(capsule_net.state_dict(), '/home/alex/Desktop/bmstu/mgmo/Pytorch_CapsuleNet/capsnet_weights.pth')
